...
/** AViewModel holds the app's UI data in a lifecycle-conscious way
 * that survive configuration changes.
...
public class MainViewModel extends ViewModel {
    ...
    // To update data stored within LiveData, must use MutableLiveData using 'setValue(T)' 'postValue(T)'
    ...
    public LiveData<ArrayList<Dish>> getLiveArrayDish(){
        ...
        liveArrayDish.setValue(dishList);
